...
Create `docs/CODEBASE_MAP.md` with this structure including YAML frontmatter with last_mapped timestamp, total_files, total_tokens; sections for System Overview with mermaid architecture diagram, Directory Structure, Module Guide per module, Data Flow with sequence diagrams, Conventions, Gotchas, and Navigation Guide.

### Step 7: Update AGENTS.md

Add or update the codebase summary in `AGENTS.md` with a 2-3 sentence summary, stack info, structure overview, and link to docs/CODEBASE_MAP.md.

If neither file exists, create `AGENTS.md` with the above content.
